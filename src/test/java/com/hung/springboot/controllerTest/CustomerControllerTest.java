package com.hung.springboot.controllerTest;
...
public class CustomerControllerTest {
    ...
    public void testCustomerController() throws Exception {
        ...
        mvc.perform(request)
                .andExpect(status().isOk()) 
                .andExpect(content().string(equalTo("[{\"id\":1,\"name\":\"Hung\",\"age\":30}]")));
        ...
        mvc.perform(request)
                .andExpect(status().isOk())
                .andExpect(content().string(equalTo("[{\"id\":1,\"name\":\"Brian\",\"age\":18}]")));
